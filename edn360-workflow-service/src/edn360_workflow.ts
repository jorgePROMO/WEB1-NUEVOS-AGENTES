        ...
        exercises: z.array(z.object({
          ...
          exercise_id: z.string()
            .refine(
              ...
              (code) => ({
                message: `❌ INVALID exercise_code: "${code}". MUST be from canonical catalog (${VALID_EXERCISE_CODES.length} valid codes). Use fileSearchExercises tool ALWAYS.`
              })
...
const E75TrainingPlanEnricherSchema = z.object({ client_training_program_enriched: z.object({ title: z.string(), summary: z.string(), goal: z.string(), training_type: z.string(), days_per_week: z.number(), session_duration_min: z.number(), weeks: z.number(), sessions: z.array(z.object({ id: z.string(), name: z.string(), focus: z.array(z.string()), blocks: z.array(z.object({ id: z.string(), primary_muscles: z.array(z.string()), secondary_muscles: z.array(z.string()), exercises: z.array(z.object({ order: z.number(), exercise_types: z.array(z.string()), name: z.string().optional(), primary_group: z.string().optional(), secondary_group: z.string().optional(), series: z.union([z.number(), z.string()]), reps: z.string(), rpe: z.union([z.number(), z.string()]), notes: z.string().optional(), video_url: z.string().optional() })) })), session_notes: z.array(z.string()) })), general_notes: z.array(z.string()) }) });
