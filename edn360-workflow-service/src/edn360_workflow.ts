...
const E7TrainingPlanAssemblerSchema = z.object({ client_training_program: z.object({ title: z.string(), summary: z.string(), goal: z.string(), training_type: z.string(), days_per_week: z.number(), session_duration_min: z.number(), weeks: z.number(), sessions: z.array(z.object({ id: z.string(), name: z.string(), focus: z.array(z.string()), blocks: z.array(z.object({ id: z.string(), primary_muscles: z.array(z.string()), secondary_muscles: z.array(z.string()), exercises: z.array(z.object({ order: z.number(), db_id: z.string(), series: z.union([z.number(), z.string()]), reps: z.string(), rpe: z.union([z.number(), z.string()]) })) })), session_notes: z.array(z.string()) })), general_notes: z.array(z.string()) }) });
const E75TrainingPlanEnricherSchema = z.object({ client_training_program_enriched: z.object({ title: z.string(), summary: z.string(), goal: z.string(), training_type: z.string(), days_per_week: z.number(), session_duration_min: z.number(), weeks: z.number(), sessions: z.array(z.object({ id: z.string(), name: z.string(), exercises: z.array(z.object({ order: z.number(), db_id: z.string(), name: z.string(), series: z.union([z.number(), z.string()]), reps: z.string(), rpe: z.union([z.number(), z.string()]), video_url: z.string() })), session_notes: z.array(z.string()) })), general_notes: z.array(z.string()) }) });
