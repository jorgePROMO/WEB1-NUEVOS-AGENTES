# EDN360 - Prompts Completos de Agentes en Producción

**Fecha de Extracción:** 2025-12-03  
**Archivo Fuente:** `/app/edn360-workflow-service/src/edn360_workflow.ts`  
**Versión del Sistema:** 2.0.0 (EVOLUTIONARY)  
...
1. [E1 - Analizador de Perfil](#e1---analizador-de-perfil)
2. [E2 - Parse Questionnaire](#e2---parse-questionnaire)
...
10. [Verificación de Paso de STATE](#verificación-de-paso-de-state)
