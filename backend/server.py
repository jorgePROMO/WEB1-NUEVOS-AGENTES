...
async def register(user_data: UserCreate):
    ...
    try:
        ...
        frontend_url = os.environ.get('FRONTEND_URL', 'https://fitagent-pro.preview.emergentagent.com')
...
async def create_subscription_session(
    ...
    try:
        ...
        origin_url = str(request.headers.get("origin", "https://fitagent-pro.preview.emergentagent.com"))
...
async def get_checkout_status(
    ...
    try:
        ...
        # Inicializar Stripe Checkout
        api_key = os.environ.get("STRIPE_API_KEY")
        webhook_url = "https://fitagent-pro.preview.emergentagent.com/api/webhook/stripe"
        stripe_checkout = StripeCheckout(api_key=api_key, webhook_url=webhook_url)
