...
async def get_checkout_status(
    ...
    try:
        ...
        # Inicializar Stripe Checkout
        api_key = os.environ.get("STRIPE_API_KEY")
        frontend_url = os.environ.get("FRONTEND_URL", "https://agent-pipeline-5.preview.emergentagent.com")
...
async def startup_db_verification():
    try:
        ...
        # Iniciar watchdogs de jobs asíncronos
        # TEMPORALMENTE DESHABILITADO - causaba bloqueo del event loop
