...
FRONTEND_URL="https://agent-pipeline-5.preview.emergentagent.com"
```
...
```bash
# Backend API URL
REACT_APP_BACKEND_URL="https://agent-pipeline-5.preview.emergentagent.com"
...
**Frontend + Backend:**
- URL: https://agent-pipeline-5.preview.emergentagent.com
- Backend API: https://agent-pipeline-5.preview.emergentagent.com/api
...
### Emergent Platform
- URL del preview: https://agent-pipeline-5.preview.emergentagent.com
