...
FRONTEND_URL="https://state-manager-1.preview.emergentagent.com"
```
...
```bash
# Backend API URL
REACT_APP_BACKEND_URL="https://state-manager-1.preview.emergentagent.com"
...
**Frontend + Backend:**
- URL: https://state-manager-1.preview.emergentagent.com
- Backend API: https://state-manager-1.preview.emergentagent.com/api
...
### Emergent Platform
- URL del preview: https://state-manager-1.preview.emergentagent.com
