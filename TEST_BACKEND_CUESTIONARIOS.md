...
TOKEN=$(curl -s -X POST "https://trainplan-admin.preview.emergentagent.com/api/auth/login?email=ecjtrainer@gmail.com&password=TU_CONTRASEÑA_AQUI" | python3 -c "import sys,json;print(json.load(sys.stdin)['token'])")

# 2. Obtener cuestionarios de Jorge2
curl -H "Authorization: Bearer $TOKEN" \
  "https://trainplan-admin.preview.emergentagent.com/api/admin/users/1764168881795908/edn360-questionnaires"
```
