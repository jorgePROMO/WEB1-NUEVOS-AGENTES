...
export const TeamClientsCRM = ({ token }) => {
  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{selectedClient.phone || selectedClient.whatsapp || 'No disponible'}</p>
                      </div>
                    </div>
                    {(selectedClient.phone || selectedClient.whatsapp) && (
                      <Button
                        ...
                        onClick={() => {
                          const phoneNumber = (selectedClient.phone || selectedClient.whatsapp).replace(/[^0-9]/g, '');
      ...
      {/* Move Client Modal */}
      {showMoveModal && clientToMove && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg w-full max-w-md">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold">Mover Cliente</h3>
                <Button
                  size="sm"
                  variant="ghost"
                  onClick={() => {
              ...
              <div className="mb-6">
                <p className="text-gray-600 mb-2">
                  <strong>Cliente:</strong> {clientToMove.nombre || clientToMove.username}
                </p>
                <p className="text-gray-600 mb-4">
                  <strong>Email:</strong> {clientToMove.email}
                </p>
                <p className="text-sm text-gray-500 mb-4">
                  ¿A qué CRM quieres mover este cliente?
                </p>
              </div>

              <div className="space-y-3">
                <Button
                  className="w-full h-16 flex flex-col items-center justify-center bg-orange-500 hover:bg-orange-600 text-white"
                  onClick={() => moveClient('external')}
                >
                  <Target className="h-6 w-6 mb-1" />
                  <span className="font-semibold">Clientes Externos</span>
